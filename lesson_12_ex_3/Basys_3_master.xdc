...
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {COL4}]
set_property IOSTANDARD LVCMOS33 [get_ports {COL4}]

#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {COL3}]
set_property IOSTANDARD LVCMOS33 [get_ports {COL3}]

#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {COL2}]
set_property IOSTANDARD LVCMOS33 [get_ports {COL2}]

#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {COL1}]
set_property IOSTANDARD LVCMOS33 [get_ports {COL1}]

#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {ROW4}]
set_property IOSTANDARD LVCMOS33 [get_ports {ROW4}]

#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {ROW3}]
set_property IOSTANDARD LVCMOS33 [get_ports {ROW3}]

#Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {ROW2}]
set_property IOSTANDARD LVCMOS33 [get_ports {ROW2}]

#Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {ROW1}]
